...
| <a name="input_internal_disks"></a> [internal\_disks](#input\_internal\_disks) | A list of internal disks to add to this machine. | <pre>list(object({<br>    size_in_mb  = number<br>    bus_type    = string<br>    bus_number  = number<br>    unit_number = number<br>  }))</pre> | `[]` | no |
